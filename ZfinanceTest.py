...
AAPLDATA = zf.TickerAnalyzer.DailyTradeCHG('AAPL', Interval='1h')
BABADATA = zf.TickerAnalyzer.DailyTradeCHG('BABA', Interval='1h')
BABACondition = [
...
# Ztimelog.Dtime("QQQB")
#zp.ZBar.OnDFBarPlot(BABADATA,TitleName = 'TRY')
# Ztimelog.Dtime("YY")
